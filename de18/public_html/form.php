    ...
    <div id="form">
        ...
        <div class="text">
            <p>
                Ich bin Reiseberaterin für Luxury Travel. Südostasien ist eine bezaubernde Region vollerzauberhafter Überraschungen. Sie werden Ihre Reise nicht vergessen. Sie stehen im Mittelunkt der Reise und schreiben dabei Ihre eigene Geschichte.
        ...
        <form class="container" method="post" action="control.php" id="submit_form">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input">
                        <input type="tel" id="phone" name="telephone" required oninvalid="setCustomValidity('Telefon ist obligatorisch')" oninput="setCustomValidity('')">
