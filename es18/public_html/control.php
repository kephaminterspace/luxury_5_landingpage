...
//        $mail->AddReplyTo("sales@luxurytravelvietnam.com");
                                                        ...
                                                        <td class="m_2396596154140361991m_8382415399398585989body_content_inner" style="font-family:Arial;line-height:1.3em;text-align:left;padding-left:55px;padding-right:55px;padding-top:30px;padding-bottom:30px;" valign="top">
                                                            <table style="font-family:Arial,sans-serif;line-height:1.3em;color:#232323" cellspacing="0" cellpadding="0" width="100%" border="0"><tbody><tr style="font-family:Arial,sans-serif;line-height:1.3em">
                                                                    <td class="m_2396596154140361991m_8382415399398585989top_content_container" style="font-family:Arial,sans-serif;line-height:1.3em;padding:22px 0 22px 0" valign="top">
                                                                        ...
                                                                        <p>
                                                                            Reciba un caluroso saludo de Luxury Travel Vietnam (es.luxurytravelvietnam.com)!
                                                                        </p>
                                                                        <p>
                                                                            Muchas gracias por su interés en los servicios de nuestra agencia de viajes en el Sudeste asiático.
                                                                        </p>
                                                                        <p>
                                                                            Este correo electrónico es para confirmarle que hemos recibido su petición como el siguiente:
                                                                        </p>
                                                                        <p>
                                                                        <table>
                                                                            <tr>
                                                                        ...
                                                                        <p>
                                                                            7. Le gustaría empezar el viaje en: <?php echo $_POST['date']; ?>
                                                                        </p>
                                                                        <p>
                                                                        ...
                                                                        <p>
                                                                            10. Número de pasajeros del grupo: <?php echo $adult; ?> Adulto<?php if($adult>1){ echo 's'; }?> y <?php echo $_POST['children_above']?$_POST['children_above']:0; ?> Niños mayores de 12 años y <?php echo $_POST['children_below']?$_POST['children_below']:0; ?> Niños menores de 12 años
                                                                        </p>
                                                                        <p>
                                                                            11. Estilo del viaje interesado: <?php echo implode(', ', $_POST['travel_style']); ?> y Categoría de alojamiento preferido: <?php echo $_POST['start']; ?>
                                                                        </p>
                                                                        <p>
                                                                            12.  Presupuesto previsto por persona: <?php echo $_POST['budget']; ?>
                                                                        </p>
                                                                        <p>
                                                                            13. Lugares favoritos: <?php echo $_POST['holiday']; ?>
                                                                        </p>
                                                                        <p>
                                                                            Nuestro equipo le responderá y enviará el primer borrador del itinerario en un plazo de 24 horas.
                                                                        </p>
                                                                        <p>
                                                                            Favor no responder a esta dirección de correo. Si tiene cualquier pregunta o necesita ayuda inmediata, no dude en mandarnos un correo a <a href="mailto:sales@luxurytravelvietnam.com">sales@luxurytravelvietnam.com</a> o contactarnos vía teléfono +84 4 3927 4120 o +84 127 254 7780
                                                                        </p>
                                                                        <p>
                                                                            Muchas gracias y saludos cordiales,
                                                                        </p>
                                                                        <p>
                                                                            El Equipo de Luxury Travel
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
        ...
        $subject = 'Su petición en viajes personalizados con Luxury Travel fue bien recibida !';
