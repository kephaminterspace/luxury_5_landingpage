    ...
    <div id="form">
        ...
        <div class="text">
            <p>I am a Travel Consultant at Luxury Travel. Southeast Asia is the charming land, full of surprises and I believe you will never regret visiting here. Let's make your journey a blockbuster, where you are the main character and create your own story.</p>
            <p>Please fill out the form below and we will reply to you within 24 hours.</p>
        </div>
        <!--group-form-->
        <form class="container" method="post" action="control.php" id="submit_form">
            ...
            <div class="row">
                <div class="col-md-4">
                    <!--email-->
                    <div class="label">
                        <label for="duration">Duration of the trip</label>
                        <p class="red">(*)</p>
                    </div>
                    <div class="input">
                ...
                <div class="col-md-9 ">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input">
                                <input type="number" placeholder="Children above 12 years old" name="children_above" oninput="setCustomValidity('')" min="0">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <!--email-->
                            ...
                            <div class="input">
                                <input type="number" placeholder="Children below 12 years old" name="children_below" oninput="setCustomValidity('')" min="0">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row ">
                <div class="col-md-4">
                    ...
                    <div class="input">
                        <select class="selectpicker" multiple name="travel_style[]" required oninvalid="setCustomValidity('Travel Style is mandatory')" onchange="setCustomValidity('')">
                            ...
                            <option >Off the beaten track</option>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input">
                        <input type="text" placeholder="USD per person" name="budget">
                    </div>
                </div>
                <div class="clear-fix"></div>
            </div>
            <div class="row ">
                <div class="col-md-12">
                    ...
                    <div class="input">
                        <textarea rows="6" placeholder="the places you want to visit, the kinds of activities you want to join in…" id='holiday' name="holiday"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <button id="submit" style="display:none;">Send inquiry</button>
        ...
        <div class="button inquiry">
            <a class="btn-rectangle">Send inquiry</a>
        </div>
